...
case "$action" in
  install)
    ...
    cp -a "$repo_root/tools/neo_dev_webhook/"{__init__,project_control,project_worker,codex_runtime,runtime_supervisor,operator_commands,verification,forced_command}.py "$stage/snapflow-neo-controller/neo_dev_webhook/"
    cp -a "$repo_root/tools/neo_dev_webhook/"{__init__,project_control,project_worker,codex_runtime,runtime_supervisor,operator_commands,verification,forced_command}.py "$stage/snapflow-neo-controller/"
